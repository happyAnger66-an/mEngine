...
class Shape : public m_engine::common::ArrayView<detail::DimType64 const>
{
public:
    using Base = m_engine::common::ArrayView<detail::DimType64 const>;
...
public:
    ...
    static Tensor of(T& data)
    {
        ...
        {
            MENGINE_CHECK(data.size() <= std::numeric_limits<DimType64>::max());
        }
