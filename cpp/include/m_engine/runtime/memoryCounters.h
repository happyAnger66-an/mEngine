...
class MemoryCounters {
 public:
  ...
  [[nodiscard]] SizeType32 getGpu() const { return mGpu; }

  [[nodiscard]] SizeType32 getCpu() const { return mCpu; }

  [[nodiscard]] SizeType32 getPinned() const { return mPinned; }

  [[nodiscard]] SizeType32 getUVM() const { return mUVM; }

  [[nodiscard]] SizeType32 getPinnedPool() const { return mPinnedPool; }
  ...
  [[nodiscard]] DiffType getPinnedPoolDiff() const { return mPinnedPoolDiff; }
