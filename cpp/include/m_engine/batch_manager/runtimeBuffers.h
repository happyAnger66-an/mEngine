...
#include "m_engine/batch_manager/common.h"
#include "m_engine/batch_manager/rnnStateManager.h"
#include "m_engine/common/optionalRef.h"
#include "m_engine/runtime/eagleBuffers.h"
#include "m_engine/runtime/explicitDraftTokensBuffers.h"
#include "m_engine/runtime/iTensor.h"
#include "m_engine/runtime/lookaheadBuffers.h"
#include "m_engine/runtime/loraManager.h"
...
namespace m_engine::batch_manager
{
...
public:
    ...
    template <typename T>
    using OptionalRef = m_engine::common::OptionalRef<T>;
