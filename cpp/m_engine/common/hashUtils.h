 ...
 *
 * Combines a hash seed with the hash of a new value using the boost
 * hash_combine algorithm. Useful for creating composite hash values.
 *
 ...
 */
template <typename T> inline void hashCombine(size_t &seed, T const &value) {
