...
#include "m_engine/batch_manager/llmRequest.h"
#include "m_engine/runtime/bufferManager.h"
#include "m_engine/runtime/common.h"
#include "m_engine/runtime/iTensor.h"
#include "m_engine/runtime/layerProfiler.h"
#include "m_engine/runtime/rawEngine.h"
...
public:
    ...
    void initializeUserBuffer(m_engine::runtime::WorldConfig const& world_config, SizeType32 maxBatchSize,
    ...
    [[nodiscard]] SizeType32 const& getCurrentBeamWidth() const noexcept
    {
        ...
        MENGINE_CHECK_WITH_INFO(mCurrentBeamWidths.size() > 0, "`mCurrentBeamWidths` is empty.");
        ...
        MENGINE_CHECK_WITH_INFO(isEqual, "beam widths in `mCurrentBeamWidths` are not all equal.");
