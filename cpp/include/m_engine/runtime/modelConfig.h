...
#include "m_engine/common/quantization.h"
#include "m_engine/runtime/common.h"
#include "m_engine/runtime/lookaheadModule.h"
#include "m_engine/runtime/loraModule.h"
#include "m_engine/runtime/speculativeDecodingMode.h"
#include "m_engine/runtime/speculativeDecodingModule.h"
...
{
public:
    // See `split_point` defined in `m_engine/models/generation_mixin.py`.
    ...
    explicit ModelConfig(SizeType32 vocabSize, SizeType32 nbLayers, SizeType32 nbAttentionLayers,
        ...
        , mNumLanguages(0)
    {
        MENGINE_CHECK_WITH_INFO(mNbLayers >= mNbAttentionLayers + mNbRnnLayers,
    ...
    {
        MENGINE_CHECK_WITH_INFO(pipelineParallelism > 0, "Invalid pipelineParallelism: %d", pipelineParallelism);
        ...
        SizeType32 pipelineParallelism = 1, SizeType32 pipelineParallelismRank = 0) const
    {
        ...
        if (mLayerTypes.empty())
        {
            ...
            MENGINE_LOG_DEBUG("Assuming uniform distribution of attention layers between ranks");
        ...
        SizeType32 pipelineParallelism = 1, SizeType32 pipelineParallelismRank = 0) const
    {
        ...
        if (mLayerTypes.empty())
        {
            ...
            MENGINE_LOG_DEBUG("Assuming uniform distribution of recurrent layers between ranks");
    ...
    {
        MENGINE_CHECK_WITH_INFO(layerIdx < mNbAttentionLayers, "Layer index %d is out of bounds", layerIdx);
    ...
    {
        MENGINE_CHECK_WITH_INFO(mSpeculativeDecodingModule, "Speculative decoding module is not set");
    ...
    {
        MENGINE_LOG_TRACE("%s start: %d", __PRETTY_FUNCTION__);
        MENGINE_CHECK_WITH_INFO(pipelineParallelism > 0, "Invalid pipelineParallelism: %d", pipelineParallelism);
        ...
        MENGINE_LOG_TRACE("%s stop: %d", __PRETTY_FUNCTION__);
    ...
    void setNumKvHeadsPerLayer(std::vector<SizeType32> const& headsPerLayer)
    {
        ...
        MENGINE_CHECK_WITH_INFO(numElems == mNbAttentionLayers,
